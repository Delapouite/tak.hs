...
testsStackStones = TestList
  ...
  , TestCase $ stackStones ('a', 2) [Stone P1 S, Stone P1 F] (Cell ('a', 2) []) @?= Cell ('a', 2) [Stone P1 S, Stone P1 F]
  ]

testsUnstackStones = TestList
  [ TestCase $ unstackStones ('a', 1) 1 (Cell ('a', 2) [Stone P1 C, Stone P2 F]) @?= Cell ('a', 2) [Stone P1 C, Stone P2 F]
  , TestCase $ unstackStones ('a', 2) 1 (Cell ('a', 2) [Stone P1 C, Stone P2 F]) @?= Cell ('a', 2) [Stone P2 F]
  , TestCase $ unstackStones ('a', 2) 2 (Cell ('a', 2) [Stone P1 C, Stone P2 F]) @?= Cell ('a', 2) []
  , TestCase $ unstackStones ('a', 2) 2 (Cell ('a', 2) [Stone P1 C, Stone P1 F, Stone P2 F]) @?= Cell ('a', 2) [Stone P2 F]
  ]
